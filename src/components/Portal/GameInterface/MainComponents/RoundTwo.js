...
class RoundTwo extends Component {
  ...
  render() {
    ...
    return (
      <div className="RoundTwo" style={{ width: window.innerWidth, height: window.innerHeight - 76 }}>
...
export default connect(mapStateToProps)(RoundTwo);